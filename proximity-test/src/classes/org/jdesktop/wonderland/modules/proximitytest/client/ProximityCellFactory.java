...
public class ProximityCellFactory implements CellFactorySPI {
    ...
    static final BoundingVolume[] clientBV = new BoundingVolume[]{
        //new BoundingBox(new Vector3f(), 0, 0, 0),
       // new BoundingBox(new Vector3f(), 3, 3, 3),
        //new BoundingBox(new Vector3f(), 1, 1, 1)
    };

     static BoundingVolume[] serverBV;
    
    public static void setserverbounds(float r){
        serverBV = new BoundingVolume[] {
        new BoundingSphere(r, new Vector3f()),
    ...
    public <T extends CellServerState> T getDefaultCellServerState(Properties props) {
        ...
        BoundingBox box = new BoundingBox(Vector3f.ZERO, 0, 0, 0);
