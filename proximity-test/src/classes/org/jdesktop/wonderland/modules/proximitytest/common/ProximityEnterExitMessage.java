...
public class ProximityEnterExitMessage extends CellMessage {
    ...
    private String proximityCellName;

    public ProximityEnterExitMessage(int index, boolean enter, String username, String cellname) {
        this.index = index;
        this.enter = enter;
        this.username = username;
        this.proximityCellName= cellname;
